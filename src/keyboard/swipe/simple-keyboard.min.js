    ...
    var t = {
              ...
              return function (h, v, g, y) {
                for (
                  var m,
                    ...
                    k = 0,
                    S = y || s,
                    I = e ? S(h, O) : n || d ? S(h, 0) : void 0;
                  O > k;
                  k++
                )
                  if ((p || k in w) && ((b = E((m = w[k]), k, x)), t))
                    if (e) I[k] = b;
                    else if (b)
                      switch (t) {
                        case 3:
        ...
        4362: function (t) {
          var e = Math.floor,
            n = function (t, i) {
              ...
              return a < 8
                ? o(t, i)
                : r(n(t.slice(0, s), i), n(t.slice(s), i), i);
            },
            o = function (t, e) {
            ...
            r = function (t, e, n) {
              for (
                var o = t.length, r = e.length, i = 0, a = 0, s = [];
                i < o || a < r;

              )
                i < o && a < r
                  ? s.push(n(t[i], e[a]) <= 0 ? t[i++] : e[a++])
                  : s.push(i < o ? t[i++] : e[a++]);
              return s;
            };
          t.exports = n;
        ...
        654: function (t, e, n) {
          ...
          t.exports = function (t, e, n, l, p, w, E) {
            ...
            if (
              ...
              if (
                ((k = { values: I(m), keys: w ? T : I(y), entries: I(b) }), E)
              )
                for (S in k) (v || P || !(S in A)) && c(A, S, k[S]);
              else o({ target: e, proto: !0, forced: v || P }, k);
            return k;
          };
        },
        7235: function (t, e, n) {
            ...
            (v = function (t) {
              ...
              if (
                (O &&
                  ...
                  (C = x.slice(d.lastIndex)),
                  d.lastIndex > 0 &&
                    (!d.multiline ||
                      (d.multiline && "\n" !== x.charAt(d.lastIndex - 1))) &&
                    ((S = "(?: " + S + ")"), (C = " " + C), I++),
                  (n = new RegExp("^(?:" + S + ")", k))),
                m && (n = new RegExp("^" + S + "$(?!\\s)", k)),
                g && (o = d.lastIndex),
                (r = p.call(O ? n : d, C)),
                O
                  ? r
                    ? ((r.input = r.input.slice(I)),
                      (r[0] = r[0].slice(I)),
                      (r.index = d.lastIndex),
                ...
                for (r.groups = u = c(null), s = 0; s < E.length; s++)
                  u[(f = E[s])[0]] = r[f[1]];
              return r;
            }),
            (t.exports = v);
            ...
            x = !u(function () {
              ...
              if (!(f && f > 3)) {
                ...
                for (t = 65; t < 76; t++) {
                  ...
                  for (o = 0; o < 47; o++) v.push({ k: e + o, v: n });
                }
                for (
                  v.sort(function (t, e) {
                    return e.v - t.v;
            ...
            { target: "Array", proto: !0, forced: y || !m || !b || !x },
            {
              sort: function (t) {
                ...
                var n,
                  ...
                  u = [],
                  l = a(e.length);
                for (o = 0; o < l; o++) o in e && u.push(e[o]);
                for (
                  n = (u = c(
                    u,
                    (function (t) {
        ...
        9653: function (t, e, n) {
          ...
          if (i(m, !b(" 0o1") || !b("0b1") || b("+0x1"))) {
            for (
              ...
              s(b, (O = S[I])) && !s(k, O) && g(k, O, v(b, O));
            (k.prototype = x), (x.constructor = k), a(r, m, k);
          }
        },
        3161: function (t, e, n) {
            ...
            for (
              var T = function (t, e) {
                  var n,
                    ...
                    m = [],
                    b = t;
                  if (!p && h && v && t.constructor === T) return t;
                  if (
                    ((h || t instanceof T) &&
                      ((t = t.source),
              ...
              N(D[j++]);
            (k.constructor = T), (T.prototype = k), h(r, "RegExp", T);
          }
          m("RegExp");
        },
        4916: function (t, e, n) {
        ...
        8783: function (t, e, n) {
          ...
          a(
            ...
            "String",
            function (t) {
              u(this, { type: s, string: r(t), index: 0 });
            },
            function () {
              var t,
                e = c(this),
          ...
          o("match", function (t, e, n) {
            return [
              ...
              function (t) {
                ...
                var f = o.unicode;
                o.lastIndex = 0;
                for (var d, p = [], h = 0; null !== (d = c(o, s)); ) {
                  var v = a(d[0]);
                  (p[h] = v),
                    "" === v && (o.lastIndex = u(s, i(o.lastIndex), f)),
                    h++;
                }
                return 0 === h ? null : p;
              },
              ...
              return [
                ...
                function (t, r) {
                  ...
                  for (var x = []; ; ) {
                    ...
                    if (null === w) break;
                    if ((x.push(w), !m)) break;
                    "" === u(w[0]) && (c.lastIndex = l(p, s(c.lastIndex), b));
                  }
                  for (var E, O = "", k = 0, S = 0; S < x.length; S++) {
                    w = x[S];
                    for (
                      var I = u(w[0]),
                        C = h(v(a(w.index), p.length), 0),
                        P = [],
                        A = 1;
                      A < w.length;
                      A++
                    )
                      P.push(void 0 === (E = w[A]) ? E : String(E));
                    var M = w.groups;
                    if (y) {
                      var T = [I].concat(P, C, p);
                      void 0 !== M && T.push(M);
                      var N = u(r.apply(void 0, T));
                    } else N = f(I, p, C, P, M, r);
                    C >= k && ((O += p.slice(k, C) + N), (k = C + I.length));
                  }
                  return O + p.slice(k);
                },
              ];
              ...
              return (
                ...
                [
                  ...
                  function (t, r) {
                    ...
                    for (var E = 0, O = 0, k = []; O < d.length; ) {
                      x.lastIndex = v ? 0 : O;
                      var S,
                        I = f(x, v ? d.slice(O) : d);
                      if (
                        null === I ||
                        (S = y(c(x.lastIndex + (v ? O : 0)), d.length)) === E
                      )
                        O = u(d, O, g);
                      else {
                        if ((k.push(d.slice(E, O)), k.length === w)) return k;
                        for (var C = 1; C <= I.length - 1; C++)
                          if ((k.push(I[C]), k.length === w)) return k;
                        O = E = S;
                      }
                    }
        ...
        2526: function (t, e, n) {
          ...
          var o = n(2109),
            ...
            it =
              ...
              c(function () {
                ...
                ? function (t, e, n) {
                    var o = W(G, e);
                    o && delete G[e], J(t, e, n), o && t !== G && J(G, e, o);
                  }
                : J,
            at = function (t, e) {
              var n = (Q[t] = x(z.prototype));
              return (
            ...
            lt = function (t, e) {
              ...
              if (n !== G || !l(Q, o) || l(Z, o)) {
                var r = W(n, o);
                return (
                  !r || !l(Q, o) || (l(n, F) && n[F][o]) || (r.enumerable = !0),
                  r
                );
              }
            },
          ...
          (u ||
            (A(
              (z = function () {
                ...
                return (
                  s && rt && it(G, e, { configurable: !0, set: n }), at(e, t)
                );
              }).prototype,
              "toString",
              function () {
            ...
            s &&
              ...
              a || A(G, "propertyIsEnumerable", ct, { unsafe: !0 }))),
          ...
          z.prototype[H] || P(z.prototype, H, z.prototype.valueOf),
            R(z, U),
            (N[F] = !0);
        },
        4747: function (t, e, n) {
      ...
      (function () {
                    ...
                    o[i].forEach(function (t) {
                      var e = document.createElement("li"),
                        n = function () {
                          ...
                          return (
                            Object.defineProperty(t, "target", { value: e }), t
                          );
                        };
        ...
        var E = (function () {
          function t() {
            ...
            if (
              (b(this, t),
              w(this, "defaultName", "default"),
              w(this, "activeInputElement", null),
              w(this, "handleParams", function (t) {
                var e, n, o;
                    ...
                    this.candidateBox.show({
                      ...
                      onSelect: function (e, n) {
                        var r = o.getInput(o.options.inputName, !0),
                          ...
                          f = (i || r.length) + l;
                        f < 0 && (f = 0),
                          o.setInput(c, o.options.inputName, !0),
                          o.setCaretPosition(f),
