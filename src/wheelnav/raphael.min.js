(function (n) {
  ...
  t.listeners = function (n) {
    for (
      ...
      for (o = [], r = 0, y = h.length; r < y; r++)
        for (t = h[r].n, v = [t[a[l]], t[s]], e = 2; e--; )
          (i = v[e]), i && (o.push(i), (c = c.concat(i.f || [])));
      h = o;
    }
    return c;
  };
  t.on = function (n, t) {
    ...
    for (e = n.split(f), i = u, r = 0, o = e.length; r < o; r++)
      (i = i.n),
        (i = (i.hasOwnProperty(e[r]) && i[e[r]]) || (i[e[r]] = { n: {} }));
  ...
  (function (n, t) {
    ...
    function hr(n, t, i, r, u) {
      var f = -3 * t + 9 * i - 9 * r + 3 * u,
        e = n * f + 6 * t - 12 * i + 6 * r;
      return n * e - 3 * t + 3 * i;
    }
    function lt(n, t, i, r, f, e, o, s, h) {
      var c;
      h == null && (h = 1);
      h = h > 1 ? 1 : h < 0 ? 0 : h;
      var l = h / 2,
    ...
    function lu(n, t, i, r, u, f, e, o, s) {
      if (!(s < 0) && !(lt(n, t, i, r, u, f, e, o) < s)) {
        for (
          var a = 1, c = a / 2, h = a - c, l = lt(n, t, i, r, u, f, e, o, h);
          y(l - s) > 0.01;

        )
          (c /= 2),
            (h += (l < s ? 1 : -1) * c),
            (l = lt(n, t, i, r, u, f, e, o, h));
        return h;
      }
    }
    function au(n, t, i, r, u, f, e, s) {
      if (
        !(o(n, i) < l(u, e)) &&
        !(l(n, i) > o(u, e)) &&
        !(o(t, r) < l(f, s)) &&
    ...
    function vu(n, t, r) {
      ...
      var et = lt.apply(0, n),
        ...
        it = r ? 0 : [];
      for (u = 0; u < b + 1; u++)
        (h = i.findDotsAtSegment.apply(i, n.concat(u / b))),
          nt.push({ x: h.x, y: h.y, t: u / b });
      for (u = 0; u < k + 1; u++)
        (h = i.findDotsAtSegment.apply(i, t.concat(u / k))),
          tt.push({ x: h.x, y: h.y, t: u / k });
      for (u = 0; u < b; u++)
        for (c = 0; c < k; c++) {
          var e = nt[u],
            a = nt[u + 1],
            s = tt[c],
            v = tt[c + 1],
            d = y(a.x - e.x) < 0.001 ? "y" : "x",
            g = y(v.x - s.x) < 0.001 ? "y" : "x",
            f = au(e.x, e.y, a.x, a.y, s.x, s.y, v.x, v.y);
          if (f) {
            if (rt[f.x.toFixed(4)] == f.y.toFixed(4)) continue;
            rt[f.x.toFixed(4)] = f.y.toFixed(4);
            p = e.t + y((f[d] - e[d]) / (a[d] - e[d])) * (a.t - e.t);
            w = s.t + y((f[g] - s[g]) / (v[g] - s[g])) * (v.t - s.t);
            p >= 0 &&
              p <= 1.001 &&
              w >= 0 &&
              w <= 1.001 &&
              (r
                ? it++
                : it.push({ x: f.x, y: f.y, t1: l(p, 1), t2: l(w, 1) }));
          }
        }
      return it;
    }
    function ai(n, t, r) {
      ...
      for (
        ...
        if (((a = n[p]), a[0] == "M")) (e = b = a[1]), (o = k = a[2]);
          ...
          for (
            a[0] == "C"
              ? ((c = [e, o].concat(a.slice(1))), (e = c[6]), (o = c[7]))
            ...
            if (((v = t[w]), v[0] == "M")) (s = d = v[1]), (h = g = v[2]);
              ...
              (v[0] == "C"
                ? ((l = [s, h].concat(v.slice(1))), (s = l[6]), (h = l[7]))
    ...
    function cr() {
      return this.x + bt + this.y + bt + this.width + " × " + this.height;
    }
    function yu(n, t, i, r, u, f) {
      function h(n) {
        return ((c * n + o) * n + e) * n;
      }
      function a(n, t) {
      ...
      function v(n, t) {
        for (var r, u, f, s, i = n, l = 0; l < 8; l++) {
          if (((f = h(i) - n), y(f) < t)) return i;
          if (((s = (3 * c * i + 2 * o) * i + e), y(s) < 1e-6)) break;
          i = i - f / s;
        }
        if (((r = 0), (u = 1), (i = n), i < r)) return r;
        if (i > u) return u;
        while (r < u) {
          if (((f = h(i)), y(f - n) < t)) return i;
          n > f ? (r = i) : (u = i);
          i = (u - r) / 2 + r;
        }
        return i;
    ...
    function pt(n, r, u, e, o, c) {
      var g, v, et, l, at, pt, ti, nt, vt, wt, yt, d, rt, ht, ct, bt, ft, lt;
      u = h(u);
      var it,
        ot,
        dt,
      ...
      if (e) {
        for (v = 0, et = f.length; v < et; v++)
          if (((g = f[v]), g.el.id == r.id && g.anim == n)) {
            g.percent != u ? (f.splice(v, 1), (dt = 1)) : (ot = g);
            r.attr(g.totalOrigin);
            break;
          }
      } else e = +tt;
      ...
      if (it) {
        if (ot) (ot.initstatus = e), (ot.start = new Date() - ot.ms * e);
          ...
          for (l in it)
            if (it[a](l) && (ki[a](l) || r.paper.customAttributes[a](l))) {
              y[l] = r.attr(l);
              y[l] == null && (y[l] = rf[l]);
              tt[l] = it[l];
              switch (ki[l]) {
                ...
                case "path":
                  for (
                    ...
                    for (
                      k[l][v] = [0], nt = 1, vt = y[l][v].length;
                      nt < vt;
                      nt++
                    )
                      k[l][v][nt] = (ti[v][nt] - y[l][v][nt]) / w;
                  break;
                case "transform":
                  if (((wt = r._), (yt = pf(wt[l], tt[l])), yt))
                    for (
                      y[l] = yt.from,
                        tt[l] = yt.to,
                        k[l] = [],
                      ...
                      for (
                        k[l][v] = [y[l][v][0]], nt = 1, vt = y[l][v].length;
                        nt < vt;
                        nt++
                      )
                        k[l][v][nt] = (tt[l][v][nt] - y[l][v][nt]) / w;
                  else
                    (d = r.matrix || new st()),
                      (rt = {
                        _: { transform: wt.transform },
                        getBBox: function () {
                          return r.getBBox(1);
                        },
                      }),
                ...
                default:
                  for (
                    ...
                    k[l][v] = ((ht[v] || 0) - (ct[v] || 0)) / w;
              }
            }
          if (
            ((bt = it.easing),
            (ft = i.easing_formulas[bt]),
            ft ||
              ((ft = b(bt).match(tf)),
              ft && ft.length == 5
                ? ((lt = ft),
                  (ft = function (n) {
                    return yu(n, +lt[1], +lt[2], +lt[3], +lt[4], w);
                  }))
                : (ft = cf)),
            (ni = it.start || n.start || +new Date()),
            (g = {
              anim: n,
              percent: u,
              timestamp: ni,
            ...
            e &&
              !ot &&
              !dt &&
              ((g.stop = !0), (g.start = new Date() - w * e), f.length == 1))
          )
            return er();
          dt && (g.start = new Date() - g.ms * e);
          f.length == 1 && hu(er);
        }
    ...
    var gt, ni, pu, wu, et, wt, vi, ht, ar, d, at, w, ti;
    i.version = "2.1.2";
    i.eve = t;
    var yi,
      pi = /[, ]+/,
      bu = { circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1 },
      ku = /\{(\d+)\}/g,
      a = "hasOwnProperty",
      ...
      b = String,
      ut = "split",
      yr = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[
        ut
      ](bt),
      ri = {
      ...
      ne = (i._ISURL = /^url\(['"]?([^\)]+?)['"]?\)$/i),
      gu = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i,
      nf = { NaN: 1, Infinity: 1, "-Infinity": 1 },
      tf = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/,
      bi = u.round,
      h = parseFloat,
      ct = parseInt,
      pr = b.prototype.toUpperCase,
      rf = (i._availableAttrs = {
        class: "",
        "arrow-end": "none",
        "arrow-start": "none",
        blur: 0,
      ...
      di = /[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/,
      uf = { hs: 1, rg: 1 },
      ff = /,?([achlmqrstvxz]),?/gi,
      ef = /([achlmrqstvz])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi,
      of = /([rstm])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi,
      wr = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/gi,
      te = (i._radial_gradient = /^r(?:\(([^,]+?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*([^\)]+?)\))?/),
      vt = {},
      ie = function (n, t) {
        return n.key - t.key;
      },
      ...
      ei = (i._rectPath = function (n, t, i, r, u) {
        return u
          ? [
              ["M", n + u, t],
              ["l", i - u * 2, 0],
      ...
      oi = (i._getPath = {
        ...
        circle: function (n) {
          var t = n.attrs;
          return br(t.cx, t.cy, t.r);
        },
        ellipse: function (n) {
          var t = n.attrs;
          return br(t.cx, t.cy, t.rx, t.ry);
        },
        rect: function (n) {
          var t = n.attrs;
          return ei(t.x, t.y, t.width, t.height, t.r);
        },
        image: function (n) {
          var t = n.attrs;
          return ei(t.x, t.y, t.width, t.height);
        },
        text: function (n) {
          var t = n._getBBox();
          return ei(t.x, t.y, t.width, t.height);
      ...
      gi = (i.mapPath = function (n, t) {
        if (!t) return n;
        var f, e, u, i, o, s, r;
        for (n = kt(n), u = 0, o = n.length; u < o; u++)
    ...
    if (
      ...
      if (
        ((gt = r.doc.createElement("div")),
        (gt.innerHTML = '<v:shape adj="1"/>'),
        (ni = gt.firstChild),
        (ni.style.behavior = "url(#default#VML)"),
        !(ni && typeof ni.adj == "object"))
      )
        return (i.type = g);
      gt = null;
    }
    ...
    i._Paper = vr;
    i.fn = c = vr.prototype = i.prototype;
    i._id = 0;
    i._oid = 0;
    i.is = function (n, t) {
      return ((t = ui.call(t)), t == "finite")
        ? !nf[a](+n)
        : t == "array"
        ? n instanceof Array
        : (t == "null" && n === null) ||
          ...
          du.call(n).slice(8, -1).toLowerCase() == t;
    };
    ...
    var si = function (n) {
      ...
      gr = function (n, t, r, u) {
        ...
        t *= 255;
        r *= 255;
        var f = { r: n, g: t, b: r, hex: i.rgb(n, t, r), toString: kr };
    ...
    i.rgb2hsl = function (n, t, i) {
      ...
      return (
        ...
        { h: e, s: h, l: u, toString: af }
      );
    };
    i._path2string = function () {
      return this.join(",").replace(ff, "$1");
    };
    wu = i._preload = function (n, t) {
    ...
    i.getRGB = it(function (n) {
      if (!n || !!((n = b(n)).indexOf("-") + 1))
        return { r: -1, g: -1, b: -1, hex: "none", error: 1, toString: dt };
      if (n == "none")
        return { r: -1, g: -1, b: -1, hex: "none", toString: dt };
      uf[a](n.toLowerCase().substring(0, 2)) ||
        n.charAt() == "#" ||
        (n = si(n));
      var u,
        f,
      ...
      return r
        ? (r[2] &&
            ((e = ct(r[2].substring(5), 16)),
            (f = ct(r[2].substring(3, 5), 16)),
            (u = ct(r[2].substring(1, 3), 16))),
          r[3] &&
            ((e = ct((s = r[3].charAt(3)) + s, 16)),
            (f = ct((s = r[3].charAt(2)) + s, 16)),
            (u = ct((s = r[3].charAt(1)) + s, 16))),
          r[4] &&
            ((t = r[4][ut](di)),
            (u = h(t[0])),
            t[0].slice(-1) == "%" && (u *= 2.55),
          ...
          ? ((t = r[6][ut](di)),
            ...
            t[3] && t[3].slice(-1) == "%" && (o /= 100),
            i.hsl2rgb(u, f, e, o))
          : ((r = { r: u, g: f, b: e, toString: dt }),
            (r.hex =
              "#" +
              (16777216 | e | (f << 8) | (u << 16)).toString(16).slice(1)),
      ...
      return n
        ? ((r = et(n)), r.arr)
          ...
          : ((u = {
            ...
            t.length ||
              b(n).replace(ef, function (n, i, r) {
                var f = [],
                  e = i.toLowerCase();
                if (
                  (r.replace(wr, function (n, t) {
                    t && f.push(+t);
                  }),
                  e == "m" &&
                    f.length > 2 &&
    ...
    i._removedFactory = function (n) {
      return function () {
        t(
          "raphael.log",
          null,
          "Raphaël: you are calling to method “" + n + "” of removed object",
          n
        );
      };
    };
    var nr = (i.pathBBox = function (n) {
        ...
        for (f = 0, p = n.length; f < p; f++)
          (t = n[f]),
            t[0] == "M"
              ? ((e = t[1]), (h = t[2]), r.push(e), u.push(h))
              : ((i = ru(e, h, t[1], t[2], t[3], t[4], t[5], t[6])),
                (r = r[s](i.min.x, i.max.x)),
                (u = u[s](i.min.y, i.max.y)),
                (e = t[5]),
                (h = t[6]));
        var a = l[v](0, r),
          y = l[v](0, u),
        ...
        return (c.bbox = yt(g)), g;
      }),
      rt = function (n) {
        var t = yt(n);
        return (t.toString = i._path2string), t;
      },
      vf = (i._pathToRelative = function (n) {
        var v = et(n),
          r,
          y,
          u,
        ...
        for (
          ...
          if (((u = f[r] = []), (t = n[r]), t[0] != ui.call(t[0]))) {
            u[0] = ui.call(t[0]);
            switch (u[0]) {
              case "a":
                u[1] = t[1];
              ...
              case "m":
                ...
                a = t[2];
              default:
                for (s = 1, p = t.length; s < p; s++)
                  u[s] = +(t[s] - (s % 2 ? o : e)).toFixed(3);
            }
          } else
            for (
              u = f[r] = [],
        ...
        return (f.toString = i._path2string), (v.rel = rt(f)), f;
      }),
      nu = (i._pathToAbsolute = function (n) {
        var p = et(n),
          w,
          t,
          r,
        ...
        for (
          ...
          if ((o.push((t = [])), (r = n[l]), r[0] != pr.call(r[0]))) {
            t[0] = pr.call(r[0]);
            switch (t[0]) {
              case "A":
                t[1] = r[1];
              ...
              case "H":
                ...
                break;
              case "R":
                for (h = [f, e][s](r.slice(1)), u = 2, a = h.length; u < a; u++)
                  (h[u] = +h[u] + f), (h[++u] = +h[u] + e);
                o.pop();
                o = o[s](sr(h, w));
                break;
            ...
            (h = [f, e][s](r.slice(1))),
              ...
              (o = o[s](sr(h, w))),
              (t = ["R"][s](r.slice(-2)));
          else for (c = 0, k = r.length; c < k; c++) t[c] = r[c];
          switch (t[0]) {
            case "Z":
              f = v;
              e = y;
      ...
      iu = function (n, t, i, r, f, e, o, h, c, l) {
        var at = (k * 120) / 180,
          et = (k / 180) * (+f || 0),
          p = [],
          g,
        ...
        if (((st = a - v), y(st) > at)) {
          ...
          h = rt + i * u.cos(a);
          c = ft + r * u.sin(a);
          p = iu(h, c, i, r, f, 0, o, ti, ii, [a, ni, rt, ft]);
        }
        st = a - v;
        var ri = u.cos(v),
          ui = u.sin(v),
          ...
          dt = [h + wt * ei, c - bt * fi],
          gt = [h, c];
        if (((nt[0] = 2 * kt[0] - nt[0]), (nt[1] = 2 * kt[1] - nt[1]), l))
          return [nt, dt, gt][s](p);
        for (
          p = [nt, dt, gt][s](p).join()[ut](","), ht = [], w = 0, vt = p.length;
          w < vt;
          w++
        )
          ht[w] = w % 2 ? ot(p[w - 1], p[w], et).y : ot(p[w], p[w + 1], et).x;
        return ht;
      },
      ci = function (n, t, i, r, u, f, e, o, s) {
        var h = 1 - s;
        return {
          x:
            nt(h, 3) * n +
      ...
      ru = it(function (n, t, i, r, f, e, s, h) {
        ...
        return (
          ...
          p > 0 &&
            p < 1 &&
            ((a = ci(n, t, i, r, f, e, s, h, p)), d.push(a.x), k.push(a.y)),
          w > 0 &&
            w < 1 &&
            ((a = ci(n, t, i, r, f, e, s, h, w)), d.push(a.x), k.push(a.y)),
          (b = e - 2 * r + t - (h - 2 * e + r)),
          (c = 2 * (r - t) - 2 * (e - r)),
          (g = t - r),
          (p = (-c + u.sqrt(c * c - 4 * b * g)) / 2 / b),
            ...
            b = function (n, t, i) {
              ...
              switch (n[0]) {
                case "M":
                  ...
                  break;
                case "A":
                  n = ["C"][s](iu[v](0, [t.x, t.y][s](n.slice(1))));
                  break;
                case "S":
                  i == "C" || i == "S"
                ...
                case "T":
                  i == "Q" || i == "T"
                    ...
                    : ((t.qx = t.x), (t.qy = t.y));
                  n = ["C"][s](tu(t.x, t.y, t.qx, t.qy, n[1], n[2]));
                  break;
                case "Q":
                  t.qx = n[1];
                  t.qy = n[2];
                  n = ["C"][s](tu(t.x, t.y, n[1], n[2], n[3], n[4]));
                  break;
                case "L":
                  n = ["C"][s](hi(t.x, t.y, n[1], n[2]));
                  break;
                case "H":
                  n = ["C"][s](hi(t.x, t.y, n[1], t.y));
                  break;
                case "V":
                  n = ["C"][s](hi(t.x, t.y, t.x, n[1]));
                  break;
                case "Z":
                  n = ["C"][s](hi(t.x, t.y, t.X, t.Y));
              }
              return n;
            },
            k = function (n, t) {
      ...
      re = (i._parseDots = it(function (n) {
        for (var f, s, c, e, r, l, u = [], t = 0, o = n.length; t < o; t++) {
          if (
            ((f = {}),
            (s = n[t].match(/^([^:]*):?([\d\.]*)/)),
        ...
        for (t = 1, o = u.length - 1; t < o; t++)
          if (!u[t].offset) {
            for (c = h(u[t - 1].offset || 0), e = 0, r = t + 1; r < o; r++)
              if (u[r].offset) {
                e = u[r].offset;
                break;
              }
            for (
              e || ((e = 100), (r = o)), e = h(e), l = (e - c) / (r - t + 1);
              t < r;
              t++
            )
              (c += l), (u[t].offset = c + "%");
      ...
      ee = (i._insertafter = function (n, t, i) {
        li(n, i);
        t == i.top && (i.top = n);
      ...
      oe = (i._insertbefore = function (n, t, i) {
        li(n, i);
      ...
      yf = (i.toMatrix = function (n, t) {
        ...
        return uu(i, t), i.matrix;
      }),
      se = (i.transformPath = function (n, t) {
        return gi(n, yf(n, t));
      }),
      uu = (i._extractTransform = function (n, t) {
        var a, d;
        if (t == null) return n._.transform;
        t = b(t).replace(/\.{3}|\u2026/g, n._.transform || g);
        var v = i.parseTransformString(t),
          y = 0,
          nt = 0,
          tt = 0,
          p = 1,
      ...
      pf = (i._equaliseTransform = function (n, t) {
        t = b(t).replace(/\.{3}|\u2026/g, n);
        n = i.parseTransformString(n) || [];
        t = i.parseTransformString(t) || [];
        for (
          var l = o(n.length, t.length), s = [], h = [], u = 0, f, c, r, e;
          u < l;
          u++
        ) {
          if (
    ...
    i._getContainer = function (n, t, u, f) {
      var e;
      if (
        ((e = f == null && !i.is(n, "object") ? r.doc.getElementById(n) : n),
        e != null)
      )
        return e.tagName
          ? t == null
    ...
    c.safari =
      (navigator.vendor == "Apple Computer, Inc." &&
        ((wt && wt[1] < 4) || navigator.platform.slice(0, 2) == "iP")) ||
      (navigator.vendor == "Google Inc." && wt && wt[1] < 8)
        ? function () {
            var n = this.rect(
              -99,
              -99,
                  ...
                  ((f = function (t) {
                    for (
                      ...
                      if (t.targetTouches[u].target == n) {
                        ...
                        t.originalEvent = e;
                        t.preventDefault = bf;
                        t.stopPropagation = df;
                        break;
                      }
                    return i.call(r, t, f.x, f.y);
                  }),
                  n.addEventListener(ri[t], f, !1)),
                function () {
                  return (
                    n.removeEventListener(t, u, !1),
                    ii && ri[t] && n.removeEventListener(ri[t], u, !1),
                    !0
                  );
                }
              );
          ...
          ? function (n, t, i, u) {
              var f = function (n) {
                ...
                var t = r.doc.documentElement.scrollTop || r.doc.body.scrollTop,
                  ...
                  o = n.clientY + t;
                return (
                  (n.preventDefault = n.preventDefault || wf),
                  (n.stopPropagation = n.stopPropagation || kf),
                  i.call(u, n, e, o)
                );
              };
              return (
          ...
          return (
            i.is(t, "function") &&
              ...
              this.events.push({
                name: n,
                f: t,
                unbind: gf(this.shape || this.node || r.doc, n, t, u || this),
              })),
            this
          );
        };
    ...
    e.removeData = function (n) {
      return (
        n == null ? (vt[this.id] = {}) : vt[this.id] && delete vt[this.id][n],
        this
      );
    };
    e.getData = function () {
      return yt(vt[this.id] || {});
    };
    ...
    e.drag = function (n, u, f, e, o, s) {
      function h(h) {
        ...
        if (((this._drag.id = h.identifier), ii && h.touches))
    ...
    e.undrag = function () {
      for (var n = ht.length; n--; )
        ht[n].el == this &&
          (this.unmousedown(ht[n].start),
          ht.splice(n, 1),
          t.unbind("raphael.drag.*." + this.id));
      ht.length || i.unmousemove(tr).unmouseup(ir);
      ot = [];
    };
    ...
    e.isPointInside = function (n, t) {
      var r = (this.realPath = oi[this.type](this));
      return (
        this.attr("transform") &&
    ...
    e.getBBox = function (n) {
      ...
      return n
        ? ((t.dirty || !t.bboxwt) &&
            ((this.realPath = oi[this.type](this)),
            (t.bboxwt = nr(this.realPath)),
            (t.bboxwt.toString = cr),
            (t.dirty = 0)),
          t.bboxwt)
        : ((t.dirty || t.dirtyT || !t.bbox) &&
            ((t.dirty || !this.realPath) &&
              ((t.bboxwt = 0), (this.realPath = oi[this.type](this))),
            (t.bbox = nr(gi(this.realPath, this.matrix))),
            (t.bbox.toString = cr),
            (t.dirty = t.dirtyT = 0)),
          t.bbox);
    };
    ...
    e.glow = function (n) {
      ...
      var t = {
        ...
        f = this.paper,
        e = f.set(),
        r = this.realPath || oi[this.type](this);
      for (r = this.matrix ? gi(r, this.matrix) : r, i = 1; i < u + 1; i++)
        e.push(
          f.path(r).attr({
            stroke: t.color,
            ...
            "stroke-width": +((t.width / u) * i).toFixed(3),
      ...
      ur = function (n, t) {
        return function (r, u, f) {
          ...
          for (a = 0, p = r.length; a < p; a++) {
            if (((e = r[a]), e[0] == "M")) (s = +e[1]), (h = +e[2]);
            else {
              if (
                ((v = rr(s, h, e[1], e[2], e[3], e[4], e[5], e[6])), l + v > u)
              ) {
                if (t && !y.start) {
                  if (
                    ((o = rr(s, h, e[1], e[2], e[3], e[4], e[5], e[6], u - l)),
    ...
    i.getSubpath = function (n, t, i) {
      if (this.getTotalLength(n) - i < 1e-6) return fr(n, t).end;
      var r = fr(n, i, 1);
    ...
    e.getTotalLength = function () {
      var n = this.getPath();
      if (n)
        return this.node.getTotalLength ? this.node.getTotalLength() : ou(n);
    };
    ...
    var f = [],
      ...
      er = function () {
        for (
          var n, l, r, u, d, c, g, w, rt, it = +new Date(), b = 0;
          b < f.length;
          b++
        )
            ...
            if (
              ...
              if (k < h) {
                    ...
                    switch (ki[r]) {
                      ...
                      case "colour":
                        e =
                          "rgb(" +
                          [
                            or(bi(o[r].r + l * h * v[r].r)),
                            or(bi(o[r].g + l * h * v[r].g)),
                            or(bi(o[r].b + l * h * v[r].b)),
                          ].join(",") +
                          ")";
                        break;
                      case "path":
                        for (e = [], u = 0, d = o[r].length; u < d; u++) {
                          for (
                            e[u] = [o[r][u][0]], c = 1, g = o[r][u].length;
                            c < g;
                            c++
                          )
                            e[u][c] = +o[r][u][c] + l * h * v[r][u][c];
                          e[u] = e[u].join(bt);
                        }
                        e = e.join(bt);
                        break;
                ...
                if (
                  ...
                  for (nt in tt) tt[a](nt) && (ft[nt] = n.totalOrigin[nt]);
                  n.el.attr(ft);
                  pt(
                    n.anim,
                    n.el,
                ...
                n.next &&
                  !n.stop &&
                  pt(n.anim, n.el, n.next, null, n.totalOrigin, n.repeat);
              }
          }
    ...
    e.animateWith = function (n, t, r, u, e, o) {
      ...
      for (
        c = r instanceof ft ? r : i.animation(r, u, e, o),
          pt(c, s, c.percents[0], null, s.attr()),
          h = 0,
          l = f.length;
        h < l;
        h++
    ...
    i.animation = function (n, t, r, u) {
      ...
      return o
        ? (r && (e.easing = r), u && (e.callback = u), new ft({ 100: e }, t))
        : new ft(n, t);
    };
    e.animate = function (n, t, r, u) {
      ...
      return f.removed
        ...
        : ((e = n instanceof ft ? n : i.animation(n, t, r, u)),
          pt(e, f, e.percents[0], null, f.attr()),
          f);
    };
    ...
    t.on("raphael.remove", lr);
    t.on("raphael.clear", lr);
    e.toString = function () {
    ...
    at = function (n) {
      if (((this.items = []), (this.length = 0), (this.type = "set"), n))
        for (var t = 0, i = n.length; t < i; t++)
          n[t] &&
            (n[t].constructor == e.constructor || n[t].constructor == at) &&
    ...
    w.push = function () {
      for (var n, t, i = 0, r = arguments.length; i < r; i++)
        (n = arguments[i]),
          n &&
            (n.constructor == e.constructor || n.constructor == at) &&
            ((t = this.items.length),
    ...
    w.animate = function (n, t, r, u) {
      ...
      for (
        u &&
          ...
          r = i.is(r, fi) ? r : s,
          e = i.animation(n, t, r, s),
          h = this.items[--f].animate(e);
        f--;

      )
        this.items[f] &&
          !this.items[f].removed &&
          this.items[f].animateWith(h, e, e),
          (this.items[f] && !this.items[f].removed) || o--;
      return this;
    };
    ...
    i.registerFont = function (n) {
      ...
      if (
        (this.fonts[u] ? this.fonts[u].push(i) : (this.fonts[u] = [i]), !n.svg)
      ) {
        i.face["units-per-em"] = ct(n.face["units-per-em"], 10);
        for (r in n.glyphs)
          if (
            n.glyphs[a](r) &&
            ((t = n.glyphs[r]),
    ...
    c.print = function (n, t, r, u, f, e, s, h) {
      ...
      if ((i.is(u, "string") && (u = this.getFont(u)), u)) {
        a = (f || 16) / u.face["units-per-em"];
        var k = u.face.bbox[ut](pi),
          rt = +k[0],
          nt = k[3] - k[1],
          ft = 0,
          et = +k[1] + (e == "baseline" ? nt + +u.face.descent : nt / 2);
        for (c = 0, tt = y.length; c < tt; c++)
          y[c] == "\n"
            ? ((d = 0), (v = 0), (w = 0), (ft += nt * h))
            : ((p = (w && u.glyphs[y[c - 1]]) || {}),
              (v = u.glyphs[y[c]]),
              (d += w ? (p.w || u.w) + ((p.k && p.k[y[c]]) || 0) + u.w * s : 0),
              (w = 1)),
            v &&
              v.d &&
              (it += i.transformPath(v.d, [
                "t",
                d * a,
                ft * a,
                "s",
      ...
      return this.path(it).attr({ fill: "#000", stroke: "none" });
    };
    c.add = function (n) {
      if (i.is(n, "array"))
        for (var u = this.set(), r = 0, f = n.length, t; r < f; r++)
          (t = n[r] || {}), bu[a](t.type) && u.push(this[t.type]().attr(t));
      return u;
    };
    ...
    i.ninja = function () {
      return wi.was ? (r.win.Raphael = wi.is) : delete Raphael, i;
    };
    (i.st = w),
      (function (n, t, r) {
        function u() {
    ...
    return (
        ...
        if (i.svg) {
          ...
          var n = function (r, f) {
              ...
              if (f) {
                ...
                for (e in f)
                  f[t](e) &&
                    (e.substring(0, 6) == "xlink:"
                      ? r.setAttributeNS(v, e.substring(6), u(f[e]))
                      : r !== undefined &&
                        ((o = u(f[e])),
                        (e !== "d" || (e === "d" && o !== "M,0,0")) &&
                          r.setAttribute(e, o)));
                ...
                (r = i._g.doc.createElementNS("http://www.w3.org/2000/svg", r)),
                  r.style &&
                    (r.style.webkitTapHighlightColor = "rgba(0,0,0,0)");
              return r;
            },
            it = function (t, r) {
              var w = "linear",
                ...
                if (
                  ((r = u(r).replace(i._radial_gradient, function (n, t, i) {
                    if (((w = "radial"), t && i)) {
                      ...
                      s = f(i);
                      var r = (s > 0.5) * 2 - 1;
                      g(b - 0.5, 2) + g(s - 0.5, 2) > 0.25 &&
                        (s = c.sqrt(0.25 - g(b - 0.5, 2)) * r + 0.5) &&
                        s != 0.5 &&
            ...
            s = function (r, f, s) {
              ...
              if (r.type == "path") {
                ...
                r._.arrows
                  ? s
                    ? (r._.arrows.endPath && e[r._.arrows.endPath]--,
                ...
                a != "none"
                  ? ((w = "raphael-marker-" + a),
                    (b = "raphael-marker-" + h + a + v + y),
                    i._g.doc.getElementById(w)
                      ? e[w]++
                      : (ht.defs.appendChild(
                          n(n("path"), {
                            "stroke-linecap": "round",
                        ...
                        (e[w] = 1)),
                    (d = i._g.doc.getElementById(b)),
                    d
                      ? (e[b]++, (tt = d.getElementsByTagName("use")[0]))
                      : ((d = n(n("marker"), {
                          id: b,
                          markerHeight: y,
                          markerWidth: v,
                        ...
                        d.appendChild(tt),
                        ht.defs.appendChild(d),
                        (e[b] = 1)),
                    n(tt, c),
                    (it = ot * (a != "diamond" && a != "oval")),
                    s
                      ? ((p = r._.arrows.startdx * g || 0),
                        (k = i.getTotalLength(l.path) - it * g))
                      : ((p = it * g),
                        (k =
                          i.getTotalLength(l.path) -
                          (r._.arrows.enddx * g || 0))),
                    (c = {}),
                    (c["marker-" + h] = "url(#" + b + ")"),
                    (k || p) && (c.d = i.getSubpath(l.path, p, k)),
                    n(ct, c),
                    (r._.arrows[h + "Path"] = w),
                    (r._.arrows[h + "Marker"] = b),
                    (r._.arrows[h + "dx"] = it),
                    (r._.arrows[h + "Type"] = a),
                    (r._.arrows[h + "String"] = f))
                  : (s
                      ? ((p = r._.arrows.startdx * g || 0),
                        (k = i.getTotalLength(l.path) - p))
                      : ((p = 0),
                        (k =
                          i.getTotalLength(l.path) -
                          (r._.arrows.enddx * g || 0))),
                    r._.arrows[h + "Path"] &&
                      n(ct, { d: i.getSubpath(l.path, p, k) }),
            ...
            nt = function (r, f) {
              ...
              for (l in f)
                if (f[t](l)) {
                  if (!i._availableAttrs[t](l)) continue;
                  e = f[l];
                  c[l] = e;
                  switch (l) {
                    case "blur":
                      ...
                      break;
                    case "title":
                      k = h.getElementsByTagName("title");
                      k.length && (k = k[0])
                        ? (k.firstChild.nodeValue = e)
                        : ((k = n("title")),
                    ...
                    case "target":
                      ...
                      g.tagName.toLowerCase() != "a" &&
                        ...
                        (g = et));
                      l == "target"
                        ? g.setAttributeNS(v, "show", e == "blank" ? "new" : e)
                        : g.setAttributeNS(v, l, e);
                      break;
                    case "cursor":
                      h.style.cursor = e;
                      break;
                    ...
                    case "path":
                      ...
                      break;
                    case "width":
                      if ((h.setAttribute(l, e), (r._.dirty = 1), c.fx))
                        (l = "x"), (e = c.x);
                      else break;
                    case "x":
                      c.fx && (e = -c.x - (c.width || 0));
                    case "rx":
                      if (l == "rx" && r.type == "rect") break;
                    case "cx":
                      h.setAttribute(l, e);
                      r.pattern && b(r);
                      r._.dirty = 1;
                      break;
                    case "height":
                      if ((h.setAttribute(l, e), (r._.dirty = 1), c.fy))
                        (l = "y"), (e = c.y);
                      else break;
                    case "y":
                      c.fy && (e = -c.y - (c.height || 0));
                    case "ry":
                      if (l == "ry" && r.type == "rect") break;
                    case "cy":
                      h.setAttribute(l, e);
                      r.pattern && b(r);
                      r._.dirty = 1;
                    ...
                    case "fill":
                            ...
                            ut &&
                              ...
                              n(ft[ft.length - 1], {
                                "stop-opacity":
                                  ...
                                  ("fill-opacity" in c ? c["fill-opacity"] : 1),
                              })));
                          c.gradient = e;
                          c.fill = "none";
                          break;
                      ...
                      w[t]("opacity") &&
                        n(h, {
                          "fill-opacity":
                            w.opacity > 1 ? w.opacity / 100 : w.opacity,
                        });
                    case "stroke":
                      w = i.getRGB(e);
            ...
            ot = function (r, f) {
              ...
              if (
                  ...
                  w = s.firstChild
                    ? tt(
                        i._g.doc.defaultView
                          .getComputedStyle(s.firstChild, o)
                ...
                if (f[t]("text")) {
                  ...
                  for (
                    h = s.getElementsByTagName("tspan"), e = 0, a = h.length;
                    e < a;
                    e++
                  )
          ...
          i._engine.path = function (t, i) {
            ...
            return (
              ...
              (r = new h(u, i)),
              (r.type = "path"),
              nt(r, { fill: "none", stroke: "#000", path: t }),
              r
            );
          };
          r.rotate = function (n, t, i) {
            ...
            return (
              this.transform(this._.transform.concat([["r", n, t, i]])), this
            );
          };
          ...
          r.remove = function () {
            ...
            if (!this.removed && this.node.parentNode) {
              ...
              for (t in this)
                this[t] =
                  typeof this[t] == "function" ? i._removedFactory(t) : null;
              this.removed = !0;
            }
          };
          r._getBBox = function () {
          ...
          r.attr = function (n, r) {
            ...
            if (r == null && i.is(n, "string")) {
              ...
              for (l = n.split(a), s = {}, o = 0, h = l.length; o < h; o++)
                (n = l[o]),
                  (s[n] =
                    n in this.attrs
                      ? this.attrs[n]
          ...
          i._engine.create = function () {
            ...
            return (
              ...
              t == 1
                ? ((r.style.cssText =
                    h + "position:absolute;left:" + o + "px;top:" + s + "px"),
          ...
          i._engine.setViewBox = function (t, i, r, u, f) {
            ...
            var o = d(r / this.width, u / this.height),
              e = this.top,
        ...
        if (i.vml) {
          var h = "hasOwnProperty",
            ...
            w = function (t, i, r, u, f, e) {
              ...
              ((y.visibility = "hidden"), i && r) &&
                ...
                e && ((l = it(e, u, f)), (u = l.dx), (f = l.dy)),
                i < 0 && (b += "x"),
                r < 0 && (b += " y") && (w = -1),
                (y.flip = b),
                (c.coordorigin = u * -d + o + f * -g),
                (h || v.fillsize) &&
                  ((s = c.getElementsByTagName(a)),
                  (s = s && s[0]),
                  c.removeChild(s),
                  h &&
                    ((l = it(e, k.x(h[0], h[1]), k.y(h[0], h[1]))),
                    (s.position = l.dx * w + o + l.dy * w)),
                  v.fillsize &&
                    (s.size = v.fillsize[0] * p(i) + o + v.fillsize[1] * p(r)),
                  c.appendChild(s)),
          ...
          var rt = function (n, i, r) {
            ...
            y = function (r, c) {
              ...
              var b = r.node,
                ...
                ci =
                  ...
                  (l.cx != c.cx ||
                    ...
                    l.ry != c.ry),
                p = r;
              for (yt in c) c[h](yt) && (l[yt] = c[yt]);
              if (
                (ei && ((l.path = i._getPath[r.type](r)), (r._.dirty = 1)),
                c.href && (b.href = c.href),
                c.title && (b.title = c.title),
                c.target && (b.target = c.target),
                c.cursor && (ut.cursor = c.cursor),
                "blur" in c && r.blur(c.blur),
                ((c.path && r.type == "path") || ei) &&
                  ((b.path = lt(
                    ~t(l.path).toLowerCase().indexOf("r")
                      ? i._pathToAbsolute(l.path)
                      : l.path
                  )),
                  r.type == "image" &&
                    ((r._.fillpos = [l.x, l.y]),
                    (r._.fillsize = [l.width, l.height]),
                    w(r, 1, 1, 0, 0, 0))),
              ...
              if (
                ("clip-rect" in c &&
                  ((nt = t(c["clip-rect"]).split(v)),
                  nt.length == 4 &&
                    ((nt[2] = +nt[2] + +nt[0]),
                    (nt[3] = +nt[3] + +nt[1]),
                    (ot = b.clipRect || i._g.doc.createElement("div")),
                    (it = ot.style),
                    (it.clip = i.format("rect({1}px {2}px {3}px {0}px)", nt)),
                    b.clipRect ||
                      ((it.position = "absolute"),
                      (it.top = 0),
                      (it.left = 0),
                      (it.width = r.paper.width + "px"),
                      (it.height = r.paper.height + "px"),
                ...
                (c.opacity != null ||
                  ...
                  (c.stroke == "none" ||
                    ...
                    c["stroke-width"] == 0) &&
                    (k.on = !1),
                  (dt = i.getRGB(c.stroke)),
                  k.on && c.stroke && (k.color = dt.hex),
                  (tt =
                  ...
                  (tt = g(d(tt, 0), 1)),
                  c["stroke-width"] == null && (et = l["stroke-width"]),
                  c["stroke-width"] && (k.weight = et),
                  et && et < 1 && (tt *= et) && (k.weight = 1),
                  (k.opacity = tt),
                  c["stroke-linejoin"] &&
                    (k.joinstyle = c["stroke-linejoin"] || "miter"),
                  ...
                  "stroke-dasharray" in c &&
                    ...
                    (k.dashstyle = gt[h](c["stroke-dasharray"])
                      ? gt[c["stroke-dasharray"]]
                      : u)),
                  kt && b.appendChild(k)),
                p.type == "text")
              ) {
                ...
                var ii = p.paper.span,
                  ri = 100,
                  bt = l.font && l.font.match(/\d+(?:\.\d*)?(?=px)/);
                for (
                  ut = ii.style,
                    l.font && (ut.font = l.font),
                    l["font-family"] && (ut.fontFamily = l["font-family"]),
                    l["font-weight"] && (ut.fontWeight = l["font-weight"]),
                    l["font-style"] && (ut.fontStyle = l["font-style"]),
                    bt = f(l["font-size"] || (bt && bt[0])) || 10,
                    ut.fontSize = bt * ri + "px",
                    p.textpath.string &&
                      (ii.innerHTML = t(p.textpath.string)
                        .replace(/</g, "&#60;")
                        .replace(/&/g, "&#38;")
                        .replace(/\n/g, "<br>")),
                    vt = ii.getBoundingClientRect(),
                    p.W = l.w = (vt.right - vt.left) / ri,
                    p.H = l.h = (vt.bottom - vt.top) / ri,
                    p.X = l.x,
                    p.Y = l.y + p.H / 2,
                    (("x" in c) || ("y" in c)) &&
                      (p.path.v = i.format(
            ...
            at = function (n, r, e) {
              ...
              if (
                ...
                (r = t(r).replace(i._radial_gradient, function (n, t, i) {
                  return (
                    ...
                    t &&
                      ...
                      ((t = f(t)),
                      (i = f(i)),
                      v(t - 0.5, 2) + v(i - 0.5, 2) > 0.25 &&
                        (i =
                          l.sqrt(0.25 - v(t - 0.5, 2)) * ((i > 0.5) * 2 - 1) +
                          0.5),
                      (w = t + o + i)),
                    u
                  );
                ...
                (r = r.split(/\s*\-\s*/)),
                y == "linear" && ((c = r.shift()), (c = -f(c)), isNaN(c))) ||
                ((s = i._parseDots(r)), !s)
              )
                return null;
              if (((n = n.shape || n.node), s.length)) {
                ...
                y == "radial"
                  ? ((e.type = "gradientTitle"),
                    ...
                    (e.focusposition = w),
                    (e.angle = 0))
                  : ((e.type = "gradient"), (e.angle = (270 - c) % 360));
                n.appendChild(e);
              }
              return 1;
            },
          ...
          r.attr = function (n, t) {
            ...
            if (t == null && i.is(n, "string")) {
              if (n == a && this.attrs.fill == "none" && this.attrs.gradient)
                return this.attrs.gradient;
              for (l = n.split(v), o = {}, e = 0, s = l.length; e < s; e++)
                (n = l[e]),
                  (o[n] =
                    n in this.attrs
                      ? this.attrs[n]
          ...
          i._engine.image = function (n, t, r, u, f, e) {
            var l = i._rectPath(r, u, f, e),
              o = n.path(l).attr({ stroke: "none" }),
              s = o.attrs,
              c = o.node,
      ...
      wi.was ? (r.win.Raphael = i) : (Raphael = i),
      i
    );
  });
